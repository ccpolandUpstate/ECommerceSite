...
class Pet_Care_Zone_Loader {
	 ...
	 * @return void
	 */
	public function pet_care_zone_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function pet_care_zone_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function pet_care_zone_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function pet_care_zone_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->pet_care_zone_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function pet_care_zone_load( $class ) {
